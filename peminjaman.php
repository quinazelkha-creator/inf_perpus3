                ...
                while($data = mysqli_fetch_array($query)){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a onclick="return confirm('Apakah anda yakin menghapus data ini?');"href="?peminjaman_hapus&&id=<?php echo $data['id_peminjaman']; ?>"class="btn btn-danger">Hapus</a>
                            <?php
                                }
                                ?>
                        </td>
