...
<div class="rows">
    <div class="col-md-12">
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <?php
            $i = 1;
                $query = mysqli_query($koneksi, "SELECT*FROM ulasan LEFT JOIN user on user.id_user = ulasan.id_user = ulasan.id_user LEFT JOIN buku on buku.id_buku = ulasan.id_buku");
